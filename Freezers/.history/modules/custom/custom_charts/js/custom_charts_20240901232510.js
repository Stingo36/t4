        ...
        function loadFreezerData(freezerName, page) {
          ...
          fetchData(url, function (data) {
            ...
            if (totalPages > 1) {
              ...
              var ul = $('<ul></ul>').addClass('pagination justify-content-center').css({
                'background-color': '#333', // Match table header background color
              ...
              var prevLink = $('<li></li>').addClass('page-item' + (page === 1 ? ' disabled' : '')).css({
                'background-color': '#333',
                'color': 'white',
                'border': '1px solid black'
              });
              prevLink.append('<a class="page-link" href="#" data-page="' + prevPage + '">Previous</a>').css('color', 'white');
        
              var nextLink = $('<li></li>').addClass('page-item' + (page === totalPages ? ' disabled' : '')).css({
                'background-color': '#333',
                'color': 'white',
                'border': '1px solid black'
              });
              nextLink.append('<a class="page-link" href="#" data-page="' + nextPage + '">Next</a>').css('color', 'white');
        
              var firstPageLink = $('<li></li>').addClass('page-item' + (page === 1 ? ' disabled' : '')).css({
                'background-color': '#333',
                'color': 'white',
                'border': '1px solid black'
              });
              firstPageLink.append('<a class="page-link" href="#" data-page="1">First</a>').css('color', 'white');
        
              var lastPageLink = $('<li></li>').addClass('page-item' + (page === totalPages ? ' disabled' : '')).css({
                'background-color': '#333',
                'color': 'white',
                'border': '1px solid black'
              });
              lastPageLink.append('<a class="page-link" href="#" data-page="' + totalPages + '">Last</a>').css('color', 'white');
              ...
              for (var i = startPage; i <= endPage; i++) {
                var pageLink = $('<li></li>').addClass('page-item' + (i === page ? ' active' : '')).css({
                  'background-color': '#333',
                  'color': 'white',
                  'border': '1px solid black'
                });
                pageLink.append('<a class="page-link" href="#" data-page="' + i + '">' + i + '</a>').css('color', 'white');
                ul.append(pageLink);
              }
