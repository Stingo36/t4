  ...
  Drupal.behaviors.customChartsAndData = {
    attach: function (context, settings) {
      $(document).ready(function () {
        ...
        // Event listeners for "Show Graph" and "Show Data" buttons
        ...
        function fetchData(url, successCallback) {
          $.ajax({
            ...
            error: function (xhr, status, error) {
              ...
              clearCache();
              showStatusMessage("No data available for the selected filter."); // Show error message
        ...
        function initializeChart(freezerName) {
          ...
          fetchData(url, function (data) {
            if (data.length === 0) {
              ...
              clearCache();
              showStatusMessage("No data available for the selected filter.");
              $("#chartdiv, #freezer-title, #buttonTrigger, #freezer-data-container").hide(); 
              toggleFilterButtons(false); 
              return;
            }
