  ...
  Drupal.behaviors.customChartsAndData = {
    attach: function (context, settings) {
      $(document).ready(function () {
        ...
        $('#buttonTrigger').html(`
          <button id="show-graph" style="background-color: #333; color: white; border: 1px solid #333; cursor: pointer;">Show Graph</button>
          <button id="show-data" style="background-color: #333; color: white; border: 1px solid #333; cursor: pointer;">Show Data</button>
        `);
        
        // Apply inline styles to filter buttons
        $('.filter-button').css({
        ...
        // Button click events to manage the active state and styling
        $('#show-graph').on('click', function () {
          $(this).css({ 'background-color': 'white', 'color': 'black' });
          $('#show-data').css({ 'background-color': '#333', 'color': 'white' });
          $('#chartdiv').show();
        ...
        $('#show-data').on('click', function () {
          $(this).css({ 'background-color': 'white', 'color': 'black' });
          $('#show-graph').css({ 'background-color': '#333', 'color': 'white' });
          $('#chartdiv').hide();
          $('#freezer-data-container').show();
          toggleFilterButtons(true); // Show filter buttons
        });
        
        // Apply inline styles to filter button click events
        $('.filter-button').on('click', function () {
          $('.filter-button').css({ 'background-color': '#333', 'color': 'white' });
          $(this).css({ 'background-color': 'white', 'color': 'black' });
        });
