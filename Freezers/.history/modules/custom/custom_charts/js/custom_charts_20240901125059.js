  ...
  Drupal.behaviors.customChartsAndData = {
    attach: function (context, settings) {
      $(document).ready(function () {
        ...
        $('#buttonTrigger').html(`
          <button id="show-graph" class="custom-button">Show Graph</button>
          <button id="show-data" class="custom-button">Show Data</button>
        `);
        
        // Apply the same class to filter buttons
        $('.filter-button').addClass('custom-button');
        
        // Update button click events to toggle the selected state styles
