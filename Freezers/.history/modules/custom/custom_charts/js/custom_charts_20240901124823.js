...
// Add two buttons to the buttonTrigger element with updated Bootstrap classes
$('#buttonTrigger').html(`
  <button id="show-graph" class="btn btn-outline-dark shadow-sm border mx-1">Show Graph</button>
  <button id="show-data" class="btn btn-outline-dark shadow-sm border mx-1">Show Data</button>
`);
