      ...
      $(document).ready(function () {
        ...
        function loadFreezerData(freezerName, page) {
          ...
          fetchData(url, function (data) {
            ...
            var table = $('<table></table>').addClass('table table-bordered table-striped table-hover').css('margin-top', '20px');
            var thead = $('<thead></thead>').addClass('thead-dark'); // Apply dark style to the header
            var headerRow = $('<tr></tr>');
