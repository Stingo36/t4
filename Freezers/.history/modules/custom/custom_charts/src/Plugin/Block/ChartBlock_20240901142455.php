...
$filter_buttons = [
  ...
  '1hr' => [
    ...
    '#attributes' => [
      ...
      'data-duration' => '1hr',
      'class' => ['btn'],
      'style' => 'background-color: white; color: black; border: 1px solid black; margin: 5px;',
    ],
  ],
  '3hr' => [
    '#type' => 'button',
...
return [
  'chart_card' => [
    '#type' => 'container',
    '#attributes' => ['class' => ['card', 'w-100', 'shadow', 'border-0', 'rounded', 'mb-4']], // Add shadow, border, and margin classes
    'header' => [
      '#type' => 'container',
      '#attributes' => ['class' => ['card-header', 'bg-primary', 'text-white']], // Use Bootstrap background and text color classes
      'status' => [
    ...
    'body' => [
      '#type' => 'container',
      '#attributes' => ['class' => ['card-body', 'p-4']], // Add padding to the card body
      'chart_container' => [
