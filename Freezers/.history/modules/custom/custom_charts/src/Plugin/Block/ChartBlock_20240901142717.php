...
class ChartBlock extends BlockBase {
  ...
  public function build() {
    ...
    return [
      'chart_card' => [
        '#type' => 'container',
        '#attributes' => ['class' => ['card', 'w-100', 'shadow', 'border', 'rounded', 'mb-4']], // Add shadow, border, and margin classes
        'header' => [
          '#type' => 'container',
          ...
          'title_and_trigger' => [
            ...
            'title' => [
              '#markup' => '<h2 id="freezer-title" class="mb-0" style="display: none; font-weight-bold;"></h2>', // Make text bold
            ],
            'trigger' => [
