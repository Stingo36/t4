...
class ChartBlock extends BlockBase {
  ...
  public function build() {
    ...
    return [
      'chart_card' => [
        '#type' => 'container',
        '#attributes' => ['class' => ['card', 'w-100', 'shadow', 'border', 'rounded', 'mb-4'], 'style' => 'height: 600px;'], // Set fixed height and add shadow, border, and margin classes
        'header' => [
          '#type' => 'container',
        ...
        'body' => [
          ...
          'details_container' => [
            '#markup' => '<div id="details-container" class="mt-4" style="display: none;">ABCASDS</div>', // Add details container with default hidden state
          ],
