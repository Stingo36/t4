...
class ChartBlock extends BlockBase {
  ...
  public function build() {
    ...
    return [
      'chart_card' => [
        '#type' => 'container',
        '#attributes' => ['class' => ['card', 'w-100', 'shadow', 'border', 'rounded', 'mb-4'], 'style' => 'height: auto;'], // Set fixed height and add shadow, border, and margin classes
        'header' => [
          '#type' => 'container',
        ...
        'body' => [
          '#type' => 'container',
          '#attributes' => ['class' => ['card-body', 'p-2', 'overflow-auto']], // Add padding and overflow to handle dynamic content
          'chart_container' => [
            '#markup' => '<div id="chart-container" class="mb-4" style="width: 100%; height: 400px; overflow-x: auto;"><div id="chartdiv" style="min-width: 600px; width: 100%; height: 100%;"></div></div>', // Add overflow-x for horizontal scroll on smaller screens
          ],
          'freezer_data_container' => [
            '#markup' => '<div id="freezer-data-container" class="mt-4"></div>', // Add margin-top
          ],
          'details_container' => [
            '#markup' => '<div id="details-container" class="mt-4" style="display: none;"></div>', // Add details container with default hidden state
          ],
